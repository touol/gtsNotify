...
class gtsNotifyHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->gtsNotify->config['jsUrl'] . 'mgr/widgets/items/channels.js');
        $this->addJavascript($this->gtsNotify->config['jsUrl'] . 'mgr/widgets/items/windows_channel.js');
        $this->addJavascript($this->gtsNotify->config['jsUrl'] . 'mgr/widgets/items/providers.js');
