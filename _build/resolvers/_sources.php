...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'gtsNotify',
                'description' => 'Default source for files of gtsNotify',
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'gtsnotify_source_default'))) {
